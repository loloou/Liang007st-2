    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
          <div className="bg-white/[0.06] rounded-2xl shadow-2xl p-8 max-w-lg w-full">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-100 mb-2">出错了</h2>
              <p className="text-slate-600">应用遇到了一个错误，请刷新页面重试</p>
            </div>

            <details className="bg-white/[0.04] rounded-lg p-4 mb-6">
