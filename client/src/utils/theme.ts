...
export const THEMES: ThemeConfig[] = [
  ...
  },
  {
    id: "dawn",
    name: "晨曦",
    description: "温暖柔和，如晨光铺纸",
    bgGradient: "from-[#f0ece4] via-[#f0ece4] to-[#ebe6dc]",
    textColor: "text-stone-800",
    accentColor: "#6b73c4",
    dotGradient: "linear-gradient(135deg, #f0ece4, #6b73c4)",
    isDark: false,
    cardBg: "rgba(247, 244, 239, 0.85)",
    borderColor: "border-stone-400/[0.12]",
    style: "glass",
    fontStyle: "sans",
  },
  {
