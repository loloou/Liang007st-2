...
export const useUiStore = create<UiState>()((set, get) => ({
  ...
  setComfyPopupOpen: (v) => set({ comfyPopupOpen: v, enginePopupOpen: v ? false : get().enginePopupOpen }),
  setEnginePopupOpen: (v) => set({ enginePopupOpen: v, comfyPopupOpen: v ? false : get().comfyPopupOpen }),
  ...
  setHistoryBatchMode: (v) => set({ historyBatchMode: v, historySelected: v ? get().historySelected : new Set() }),
  ...
  // ── 管理弹窗 ──────────────────────────────────────────────────────────────
  openManageDialog: (type) => set({ manageDialogOpen: true, manageDialogType: type, inlineEditing: null }),
  ...
  appendLogEntry: (entry) =>
    set((s) => ({ logEntries: [...s.logEntries.slice(-99), entry] })),
