...
export const SPECIMEN_CONFIGS: Record<Exclude<SpecimenType, 'none'>, SpecimenConfig> = {
  immersed: {
    ...
    basePrompt:
      '中药浸制标本，透明广口磨砂玻璃标本瓶，中性保色浸制液，液体通透无浑浊无气泡，液面平整，瓶口蜡封，[中药正式名]完整舒展，保色完好，无破损，瓶身右侧贴规范白底黑字标签（标注品名、拉丁名、科属、产地、采收时间），超白钢化玻璃恒温恒湿展柜，防紫外线漫射柔光，无玻璃强反光，瓶身轻微环境反光，8K超清，nanobanana超写实渲染，物理级玻璃材质，微距细节拉满，景深效果，锐化合理',
    negativePrompt:
      '模糊、失真、液体浑浊、植株残缺、标签缺失、比例失调、过度饱和、玻璃强反光、气泡过多',
  ...
  herbarium: {
    ...
    basePrompt:
      '中药腊叶标本，标准40cm×30cm白色道林纸台纸，[中药正式名]全株标本，根、茎、叶、花、果实完整，叶片平整正反面展示，白色棉线规范固定，无褶皱无破损，右下角贴规范采集标签（中文名、拉丁名、科属、产地、采集人、采集时间），漫射柔光，无反光，超写实植物纹理，纸质质感拉满，8K超清，nanobanana物理级渲染，微距细节清晰，无畸变',
  ...
  crude_drug: {
    ...
    basePrompt:
      '[中药正式名]生药标本，符合《中国药典》2025版性状描述，完整原药材，表皮纹理清晰，自然色泽，断面展示完整的放射状纹理/纤维结构/粉质特征，放置于灰色哑光展台，规范标签标注品名、产地、药用部位，防眩光漫射柔光，无反光，超写实材质质感，8K超清，nanobanana超写实渲染，细节拉满，景深效果，无色彩失真',
  ...
  decoction_pieces: {
    ...
    basePrompt:
      '[中药正式名][炮制规格]饮片标本，符合《中国药典》2025版性状标准，[片型：类圆形厚片/斜片/段状]，厚度均匀，外表皮纹理清晰，切面完整展示导管孔/放射状纹理/皮部木部分层，炮制后自然色泽，整齐排列于白色哑光标本盘，规范标签标注品名、炮制规格、产地、生产批号，漫射柔光，无反光，超写实饮片质感，8K超清，nanobanana物理级渲染，微距细节拉满，锐化合理',
...
export const HERB_DATABASE: Record<string, HerbEntry[]> = {
  immersed: [
    ...
    },
    {
      ...
      origin: '云南',
      part: '根茎',
      latinName: 'Paris polyphylla Smith',
    },
    {
      name: '天门冬',
      family: '百合科',
    ...
    },
    {
      ...
      origin: '甘肃兰州',
      part: '肉质鳞叶',
      latinName: 'Lilium brownii F.E.Brown ex Miellez',
    },
    {
      name: '太子参',
      family: '石竹科',
      origin: '贵州',
      part: '块根',
      latinName: 'Pseudostellaria heterophylla (Miq.) Pax',
    },
    {
      name: '何首乌',
      family: '蓼科',
      origin: '河南',
      part: '块根',
      latinName: 'Fallopia multiflora (Thunb.) Harald.',
    },
    {
      name: '地黄',
      family: '玄参科',
    ...
    },
    {
      ...
      origin: '贵州',
      part: '块茎',
      latinName: 'Bletilla striata (Thunb.) Rchb.f.',
    },
    {
      name: '石斛',
      family: '兰科',
      origin: '云南',
      part: '茎',
      latinName: 'Dendrobium nobile Lind.',
    },
    {
      name: '铁皮石斛',
      family: '兰科',
  ...
  herbarium: [
    ...
    },
    {
      ...
      origin: '河北',
      part: '叶',
      latinName: 'Isatis indigotica Fortune',
    },
    {
      name: '艾叶',
      family: '菊科',
      origin: '湖北蕲春',
      part: '叶',
      latinName: 'Artemisia argyi Lévl. et Van.',
    },
    {
      name: '紫苏叶',
      family: '唇形科',
    ...
    },
    {
      ...
      origin: '陕西',
      part: '叶',
      latinName: 'Epimedium brevicornu Maxim.',
    },
    {
      name: '鱼腥草',
      family: '三白草科',
    ...
    },
    {
      ...
      origin: '陕西',
      part: '地上部分',
      latinName: 'Artemisia capillaris Thunb.',
    },
    {
      name: '瞿麦',
      family: '石竹科',
  ...
  crude_drug: [
    ...
    },
    {
      ...
      origin: '安徽',
      part: '根',
      latinName: 'Platycodon grandiflorus (Jacq.) A.DC.',
    },
  ],
  decoction_pieces: [
    {
